    ...
    private void drawBezier(Canvas canvas) {
        ...
        if (isEvenCyclic()) {
            if (mAngle % mRadian < mRadian / 2) {
                ...
                canvas.drawPoint(rightX + (leftX - rightX) / (mRadian / 2) * (mAngle % mRadian > (mRadian / 2) ? (mRadian / 2) : mAngle % mRadian), rightY + (leftY - rightY) / (mRadian / 2) * (mAngle % mRadian > (mRadian / 2) ? (mRadian / 2) : mAngle % mRadian), mPaint);
                canvas.drawText("5", rightX + (leftX - rightX) / (mRadian / 2) * (mAngle % mRadian > (mRadian / 2) ? (mRadian / 2) : mAngle % mRadian), rightY + (leftY - rightY) / (mRadian / 2) * (mAngle % mRadian > (mRadian / 2) ? (mRadian / 2) : mAngle % mRadian), mPaint);
                canvas.drawPoint(leftX + (rightX - leftX) / (mRadian / 2) * (mAngle % mRadian > (mRadian / 2) ? (mRadian / 2) : mAngle % mRadian), leftY + (rightY - leftY) / (mRadian / 2) * (mAngle % mRadian > (mRadian / 2) ? (mRadian / 2) : mAngle % mRadian), mPaint);
                canvas.drawText("6", leftX + (rightX - leftX) / (mRadian / 2) * (mAngle % mRadian > (mRadian / 2) ? (mRadian / 2) : mAngle % mRadian), leftY + (rightY - leftY) / (mRadian / 2) * (mAngle % mRadian > (mRadian / 2) ? (mRadian / 2) : mAngle % mRadian), mPaint);
            ...
            if (circleIndex > 0 && mAngle % mRadian > mRadian / 2) {
                ...
                canvas.drawPoint(pointF4.x, pointF4.y, mPaint);
                canvas.drawText("4", pointF4.x, pointF4.y, mPaint);
                canvas.drawPoint(rightX + (leftX - rightX) / (mRadian / 2) * (mRadian - mAngle % mRadian > (mRadian / 2) ? (mRadian / 2) : (mRadian - mAngle % mRadian)), rightY + (leftY - rightY) / (mRadian / 2) * (mRadian - mAngle % mRadian > (mRadian / 2) ? (mRadian / 2) : (mRadian - mAngle % mRadian)), mPaint);
                canvas.drawText("5", rightX + (leftX - rightX) / (mRadian / 2) * (mRadian - mAngle % mRadian > (mRadian / 2) ? (mRadian / 2) : (mRadian - mAngle % mRadian)), rightY + (leftY - rightY) / (mRadian / 2) * (mRadian - mAngle % mRadian > (mRadian / 2) ? (mRadian / 2) : (mRadian - mAngle % mRadian)), mPaint);
                canvas.drawPoint(leftX + (rightX - leftX) / (mRadian / 2) * (mRadian - mAngle % mRadian > (mRadian / 2) ? (mRadian / 2) : (mRadian - mAngle % mRadian)), leftY + (rightY - leftY) / (mRadian / 2) * (mRadian - mAngle % mRadian > (mRadian / 2) ? (mRadian / 2) : (mRadian - mAngle % mRadian)), mPaint);
                canvas.drawText("6", leftX + (rightX - leftX) / (mRadian / 2) * (mRadian - mAngle % mRadian > (mRadian / 2) ? (mRadian / 2) : (mRadian - mAngle % mRadian)), leftY + (rightY - leftY) / (mRadian / 2) * (mRadian - mAngle % mRadian > (mRadian / 2) ? (mRadian / 2) : (mRadian - mAngle % mRadian)), mPaint);
